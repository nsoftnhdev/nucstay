    ...
    room && (
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-2">
          ...
          <p className="text-xs font-inter py-1.5 px-3 text-white bg-sky-500 rounded-full">
            20% OFF
          </p>
        </div>
              ...
              room.images.map((image, index) => (
                <img
                  className={`w-full rounded-xl shadow-md object-cover cursor-pointer ${
                    mainImage === image && "outline-3 outline-sky-500"
                  }`}
        ...
        <div className="flex flex-col md:flex-row md:justify-between mt-10">
          ...
          {/* Room Price */}
          <p className="text-2xl font-medium">RM{room.pricePerNight}/night</p>
        </div>
        ...
        <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
          <p>
            ...
            The price quoted is for two guest, at the quest slot please mark the
